...
## <a name="view-and-edit-device-policies"></a>Exibir e Editar Diretivas de dispositivo
...
2. No NAV esquerdo, escolha **políticas**de **dispositivos** \> .

    Nesta página pode criar, editar, alterar o grupo de destino ou eliminar uma política.

    ![Screenshot of the Policies page](media/devicepolicies.png)
  
## <a name="view-and-manage-devices"></a>Exibir e gerenciar dispositivos


1. No NAV esquerdo, escolha Gerenciar **dispositivos** \> ****. 
