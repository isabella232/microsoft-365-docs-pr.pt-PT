---
title: Como é que as funcionalidades de proteção no mapa Do Microsoft 365 Business Premium para configurações Intune
f1.keywords:
- NOCSH
ms.author: sirkkuw
author: Sirkkuw
...
Para encontrar a definição Intune, inscreva-se com as suas credenciais de administrador Microsoft 365 Business Premium e vá aos **centros de administração**, e depois **Intune**.
...
Para encontrar a definição Intune, inscreva-se com as suas credenciais de administrador Microsoft 365 Business Premium e vá ao [portal Azure](https://portal.azure.com). Selecione **Mais serviços**, e escreva Insintonização no **Filtro**. Selecione **Intune App Protection** \> **App Policy**.
  
 > [!IMPORTANT]
 >
 >Uma subscrição Microsoft 365 Business Premium dá-lhe uma licença para modificar apenas as definições intune que mapeiam para as definições disponíveis no Microsoft 365 Business Premium. 
